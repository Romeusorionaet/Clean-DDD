...
- Linguagem ubígua (todas as pessoas involvida na construção do software consegue conversar por igual).
...
São nomeclaturas para a entidade Usuário, usamos muito "usuário / user" mas nosso cliente nem usa essa nomeclatura e o Expert de domínio pode listar outros como por exemplo essas que foram listado acima.
